...
import { WorkProgressType, WorkProgressStatus } from '@/data/mockData';
...
export default function NewProgressPage() {
  ...
  const [form, setForm] = useState({
    project_name: '',
    project_type: '修繕工程' as WorkProgressType,
    status: '規劃中' as WorkProgressStatus,
    stages: '規劃,施工,驗收,完成',
    current_stage: '規劃',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('新增工作進程（Prototype）:', form);
    setSaved(true);
    ...
    <AdminLayout>
      <div className="max-w-2xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-xl font-bold text-gray-800">新增工作進程</h1>
        </div>
